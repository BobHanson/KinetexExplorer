...
function getapplet(name,codebase,archive,height,width,script,msgcallback,animframecallback,pickcallback,loadstructcallback){
 var s='\n<applet name="'+name+'" code="JmolApplet"'
	if(codebase)s+='\ncodebase="'+codebase+'"'
	s+='\narchive="'+archive+'"'
	+'\nwidth="'+width+'" height="'+height+'"  mayscript="true" '
	if(animframecallback)s+='\n animFrameCallback="'+animframecallback+'"'
	if(msgcallback)s+='\n MessageCallback="'+msgcallback+'"'
	if(pickcallback)s+='\n PickCallback="'+pickcallback+'"'
	if(loadstructcallback)s+='\n LoadStructCallback="'+loadstructcallback+'"'
	s+='>'
