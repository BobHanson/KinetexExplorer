...
newCI("_uni4","|Mechanistic steps fall into two basic categories: <b>unimolecular</b> and <b>bimolecular</b>. "
	+"Unimolecular mechanistic steps involve only a singe molecule of reactant. Examples of unimolecular steps are <b>isomerization</b>, whereby one species converts to another directly, and <b>dissociation</b>, whereby one species splits up to give two others."
	,"mech1.gif"
...
newCI("_s4","The simplest reaction mechanism consist of a just a single irreversible mechanistic step. "
...
newCI("_enz5","An <b>enzyme</b> is a biological catalyst, usually a <b>protein</b> with very high molecular weight."
	,"enz1.gif"
...
newCI("_osc5","<b>Oscillating reactions</b> are very curious beasts. While the mechanisms of real oscillating reactions are largely unknown, several mechanisms have been proposed." 
	,"oscilate.gif"
	...
	,"|"
	,"oscilate4.gif"
	,"|see Exploration $EXP(oscil) for a demonstration."
	,"oscilate5.gif"
	)
